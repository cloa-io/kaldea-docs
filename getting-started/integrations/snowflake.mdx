...
Go to Kaldea Settings. Click `+ Add Datasource' in the sidebar to create a new Data Source. Use user credentials you have already created to fill in the necessary input fields. 
